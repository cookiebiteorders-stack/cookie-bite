-- =============================================================================
-- Cookie Bite — Migration 0121: Use null defaults for JSON fields
-- =============================================================================
-- This migration changes the JSON field defaults from empty objects/arrays to null
-- to avoid potential JSON parsing issues in different PostgreSQL versions
-- =============================================================================

-- Recreate the function with null defaults instead of empty objects/arrays
...
BEGIN
  ...
  FOR v_item_idx IN 0..jsonb_array_length(p_items)-1 LOOP
    ...
    -- Extract JSON fields directly using -> operator (pass through null as-is)
    BEGIN
