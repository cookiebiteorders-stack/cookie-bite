-- =============================================================================
-- Cookie Bite — Debug: Try inserting without JSON fields
-- =============================================================================

-- Recreate function without JSON fields to isolate the issue
...
BEGIN
  ...
  -- Insert order items WITHOUT JSON fields to isolate the issue
  FOR v_item_idx IN 0..jsonb_array_length(p_items)-1 LOOP
    v_item := p_items->v_item_idx;
    v_slug := v_item->>'slug';
    v_quantity := (v_item->>'quantity')::integer;
    ...
    -- Insert order item WITHOUT JSON fields
    BEGIN
