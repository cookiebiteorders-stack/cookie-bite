...
export function getOurCookiesPageFaq(lang: Lang): Array<{ q: string; a: string }> {
  if (lang === "ar") {
    return [
      {
        q: "ما الفرق بين «قائمة الكوكيز» والمتجر؟",
        a: "قائمة الكوكيز تعرض التشكيلة حسب المجموعات (كلاسيك، شوكولاتة، محشية، موسمية). المتجر يتيح الفلترة والبحث والطلب المباشر.",
      },
      {
