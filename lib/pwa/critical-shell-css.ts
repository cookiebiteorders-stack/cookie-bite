...
export const CRITICAL_SHELL_CSS = [
  ...
  ".cb-header-spacer{flex-shrink:0;height:calc(3.5rem + var(--cb-announcement-offset,0px))}",
  ".cb-header-spacer--mobile{display:block}",
  ".cb-header-spacer--desktop{display:none}",
  "@media(min-width:768px){.cb-header-spacer{height:calc(4rem + var(--cb-announcement-offset,0px))}.cb-header-spacer--mobile{display:none}.cb-header-spacer--desktop{display:block}html{scroll-padding-top:calc(4rem + var(--cb-announcement-offset,0px))}}",
  "html{scroll-padding-top:calc(3.5rem + var(--cb-announcement-offset,0px))}",
