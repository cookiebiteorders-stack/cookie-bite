...
export const CRITICAL_SHELL_CSS = [
  ":root{--cb-cream:#fffaf4;--background:#fffaf4;--foreground:#2d1810;--cb-text:#5c3d2e;--cb-text-strong:#2d1810;--cb-terracotta-dark:#ea580c;color-scheme:light}",
  ...
  ".cb-skip-link:focus{left:1rem;top:1rem;width:auto;height:auto;padding:.5rem 1rem;background:#fff;border:2px solid #ea580c;border-radius:.5rem;z-index:9999}",
