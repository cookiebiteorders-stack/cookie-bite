  ...
  .object({
    ...
    shipping: z
      .object({
        ...
        phone_secondary: z.union([z.string().regex(/^01[0125][0-9]{8}$/), z.literal(null)]),
        address: z.string().min(5),
        city: z.string().min(2),
        governorate: z.union([z.string(), z.literal(null)]),
        notes: z.union([z.string(), z.literal(null)]),
        email: z.union([z.string().email(), z.literal(""), z.literal(null)]),
        delivery_date: z.union([z.string(), z.literal(null)]),
        delivery_time: z.union([z.string(), z.literal(null)]),
        latitude: z.union([z.number(), z.literal(null)]),
        longitude: z.union([z.number(), z.literal(null)]),
        place_label: z.union([z.string(), z.literal(null)]),
      })
      .nullable(),
