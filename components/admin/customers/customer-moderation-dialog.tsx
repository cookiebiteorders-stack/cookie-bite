...
> = {
  delete: {
    title: "حذف العميل",
    description:
      "سيُحذف ملف العميل من النظام ويُحذف حساب المصادقة من Supabase Auth. الطلبات السابقة تبقى. البريد لن يُحظر — يمكن للعميل التسجيل مجدداً بنفس العنوان.",
  ...
  block: {
    ...
    description:
      "سيُحظر البريد من التسجيل مستقبلاً، ويُحذف ملف العميل من النظام، ويُحذف حساب المصادقة من Supabase Auth. الطلبات السابقة تبقى في السجلات.",
