...
export function HeroSection5Client() {
  ...
  const instantHero = lowPower || prefersReduced;
      ...
      <section className="relative min-h-[100svh] w-full">
        <div className="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-7xl flex-col cb-gutter pb-[max(4rem,env(safe-area-inset-bottom))] pt-[max(4.5rem,env(safe-area-inset-top))] md:pb-28 md:pt-24 lg:block lg:pb-36 lg:pt-28">
          <div className="relative mx-auto max-w-lg text-center lg:ms-4 lg:me-auto lg:max-w-2xl lg:text-start">
            <motion.p
              initial={instantHero ? false : { opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{
                delay: instantHero ? 0 : 0.08,
                duration: instantHero ? 0.01 : 0.7,
                ease: soft,
              }}
            ...
            <motion.h1
              initial={instantHero ? false : { opacity: 0, y: 28 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{
                delay: instantHero ? 0 : 0.18,
                duration: instantHero ? 0.01 : 0.75,
                ease: soft,
              }}
            ...
            <motion.p
              initial={instantHero ? false : { opacity: 0, y: 22 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{
                delay: instantHero ? 0 : 0.32,
                duration: instantHero ? 0.01 : 0.72,
                ease: soft,
              }}
            ...
            <motion.div
              initial={instantHero ? false : { opacity: 0, y: 18 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{
                delay: instantHero ? 0 : 0.46,
                duration: instantHero ? 0.01 : 0.65,
                ease: soft,
              }}
